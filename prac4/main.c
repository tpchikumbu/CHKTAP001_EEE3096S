...
uint32_t saw_LUT[NS] = {
  ...
  488,496,504,512,519,527,535,543,551,559,
...
uint32_t triangle_LUT[NS] = {
  ...
  496,512,527,543,559,575,591,607,623,639,
  655,671,687,703,719,735,751,767,783,799,
  815,831,847,863,879,895,911,927,943,959,
  975,991,1007,1023,1007,991,975,959,943,927,
  911,895,879,863,847,831,815,799,783,767,
  751,735,719,703,687,671,655,639,623,607,
  591,575,559,543,527,512,496,480,464,448,
  432,416,400,384,368,352,336,320,304,288,
  272,256,240,224,208,192,176,160,144,128,
  112,96,80,64,48,32,16,0
};

char* names[] = {"Sine", "Sawtooth", "Triangle"};
uint32_t* tables[] = {Sin_LUT, saw_LUT, triangle_LUT};
uint32_t wave = 0, prev = 0, curr = 0;
...
void EXTI0_1_IRQHandler(void)
{
  ...
  HAL_DMA_Start_IT(&hdma_tim2_ch1, tables[wave], DestAddress, NS);
  __HAL_TIM_ENABLE_DMA(&htim2, TIM_DMA_CC1);
